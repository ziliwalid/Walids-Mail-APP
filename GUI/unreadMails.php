            ...
            <div class="grid email">
                <div class="grid-body">
                    <div class="row">
                        <!-- BEGIN INBOX MENU -->
                        <div class="col-md-3">
                            <h2 class="grid-title"><span style="color: #fe302f"><?=$name?></span> Here's your<br> <i class="fa-solid fa-book"></i> Unread E-mails</h2><br>
                            ...
                            <div class="lol">
                                <nav class="nav flex-column">
                                    <center>
                                        <a class="nav-link btn btn-outline-primary" href="./Message.php">Inbox <i class="fa fa-inbox"></i></a><br>
